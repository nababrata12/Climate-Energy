...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <h2 className='font-extrabold text-2xl hidden sm:block 
      justify-center items-center mt-auto mb-auto'>
        INDIA CLIMATE & ENERGY DASHBOARD</h2>
      ...
      <div className="flex justify-center items-center">
        ...
        <div className='w-0.5 h-8 ml-2 bg-black mx-auto mb-auto mt-auto'></div>
